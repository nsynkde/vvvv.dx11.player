...
extern "C"
{
	...
	BLUEPLAYBACK_API BLUERENDERER_HANDLE BlueRendererCreate(HANDLE tex_handle, int outFormat)
	{
		try{
			return new BlueFishRendererDX11(tex_handle,(EMemoryFormat)outFormat);
		}catch (std::exception & e){
			WCHAR    str[1024];
			MultiByteToWideChar( 0,0, e.what(), strlen(e.what()), str, strlen(e.what())+1);
