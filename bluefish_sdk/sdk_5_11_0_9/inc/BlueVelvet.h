...
public:
	...
	virtual BErr device_enumerate(int& Devices) = 0;

	//	4.1.2	device_attach
	//			Attach the class instance to the indexed device. 
	virtual BErr device_attach(	int DeviceId,
								int do_audio	// DEPRECATED; SET TO 0
								) = 0;

	//	4.1.3	device_detach
	//			Detach the current device from the class instance.
	virtual BErr device_detach(void) = 0;

	//	4.1.4	device_attach_audio
	//			Attach the class instance to the audio I/O component of the current device.
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	device_attach_audio(void) = 0;

	//	4.1.5	device_detach_audio
	//			Remove audio I/O components of the current device from the class instance.
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	device_detach_audio(void) = 0;

	//	4.1.6	device_attach_audio_in
	//			Attach the class instance to the audio IINPUT component of the current device.
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	device_attach_audio_in(void) = 0;

	//	4.1.7	device_detach_audio_in
	//			Remove audio INPUT component of the current device from the class instance.
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	device_detach_audio_in(void) = 0;

	//	4.1.8	device_attach_audio_out
	//			Attach the class instance to the audio OUTPUT component of the current device.
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	device_attach_audio_out(void) = 0;

	//	4.1.9	device_detach_audio_out
	//			Remove audio OUTPUT component of the current device from the class instance. 
    virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	device_detach_audio_out(void) = 0;

	//	4.1.10	device_get_bar
	//			Get device Bar assets from driver
    virtual BErr device_get_bar(unsigned long BarN, void** ppAddress, unsigned long& Length) = 0;

	//	4.2		Feature Assessment Functions
	//---------------------------------
	//	4.2.1	has_timing_adjust
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_timing_adjust(int DeviceId = 0) = 0;

	//	4.2.2	has_vertical_flip
	virtual  __declspec(deprecated("Deprecated. Do not use."))
	int		has_vertical_flip(int DeviceId = 0) = 0;

	//	4.2.3	has_half_res
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_half_res(int DeviceId = 0) = 0;

	//	4.2.4	has_dissolve
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_dissolve(int DeviceId = 0) = 0;

	//	4.2.5	has_aperture
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_aperture(int DeviceId = 0) = 0;

	//	4.2.6	has_input_sdi
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_input_sdi(int DeviceId = 0) = 0;

	//	4.2.7	has_output_sdi
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_output_sdi(int DeviceId = 0) = 0;

	//	4.2.8	has_input_composite
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_input_composite(int	DeviceId = 0) = 0;

	//	4.2.9	has_output_composite
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_output_composite(int DeviceId = 0) = 0;

	//	4.2.10	has_input_yuv
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_input_yuv(int DeviceId = 0) = 0;

	//	4.2.11	has_output_yuv
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_output_yuv(int DeviceId = 0) = 0;

	//	4.2.12	has_output_rgb
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_output_rgb(int DeviceId = 0) = 0;

	//	4.2.13	has_input_svideo
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_input_svideo(int DeviceId = 0) = 0;

	//	4.2.14	has_output_svideo
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_output_svideo(int DeviceId = 0) = 0;

	//	4.2.15	has_output_key
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_output_key(int DeviceId = 0) = 0;

	//	4.2.16	has_output_key_v4444
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_output_key_v4444(int DeviceId = 0) = 0;

	//	4.2.17	has_letterbox
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_letterbox(int DeviceId = 0) = 0;

	//	4.2.18	has_video_memory
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_video_memory(int DeviceId = 0) = 0;

	//	4.2.18	has_video_memory_base
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_video_memory_base(int DeviceId = 0) = 0;

	//	4.2.19	has_video_cardtype
	virtual int has_video_cardtype(int DeviceId = 0) = 0;

	//	4.2.20	count_video_mode
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		count_video_mode(int DeviceId = 0) = 0;

	//	4.2.21	enum_video_mode
	virtual __declspec(deprecated("Deprecated. Do not use."))
	EVideoMode enum_video_mode(int Index, int DeviceId = 0) = 0;

	//	4.2.22	count_memory_format
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		count_memory_format(int DeviceId = 0) = 0;

	//	4.2.23	enum_memory_format
	virtual __declspec(deprecated("Deprecated. Do not use."))
	EMemoryFormat enum_memory_format(int Index, int DeviceId = 0) = 0;

	//	4.2.24	count_update_method
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		count_update_method(int	DeviceId = 0) = 0;

	//	4.2.25	enum_update_method
	virtual __declspec(deprecated("Deprecated. Do not use."))
	EUpdateMethod enum_update_method(int Index, int DeviceId = 0) = 0;

	//	4.2.26	has_audio_input
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_audio_input(int	DeviceId = 0) = 0;

	//	4.2.27	has_audio_output
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_audio_output(int DeviceId = 0) = 0;

	//	4.2.28	count_audio_input_rate
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		count_audio_input_rate(int DeviceId = 0) = 0;

	//	4.2.29	count_audio_output_rate
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		count_audio_output_rate(int	DeviceId = 0) = 0;

	//	4.2.30	enum_audio_input_rate
	//			Returns the enumeration for the Ith supported audio input rate.
	virtual __declspec(deprecated("Deprecated. Do not use."))
	EAudioRate enum_audio_input_rate(int Index, int DeviceId = 0) = 0;

	//	4.2.31	enum_audio_output_rate
	//			Returns the enumeration for the Ith supported audio output rate.
	virtual __declspec(deprecated("Deprecated. Do not use."))
	EAudioRate enum_audio_output_rate(int Index, int DeviceId = 0) = 0;

	//	4.2.32	has_audio_playthru
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_audio_playthru(int DeviceId = 0) = 0;

	//	4.2.33	has_dma_control
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_dma_control(int	DeviceId = 0) = 0;

	//	4.2.34	has_scaled_rgb
	virtual __declspec(deprecated("Deprecated. Do not use."))
	int		has_scaled_rgb(int DeviceId = 0) = 0;

	//	4.3	Control Functions
	//---------------------------------
	//	4.3.1	set_timing_adjust
	//			Determines the video format of a signal applied to the Link A input. 
	virtual __declspec(deprecated("Deprecated. Do not use. See AN004_Genlock.pdf"))
	BErr	set_timing_adjust(unsigned int HPhase, unsigned int VPhase) = 0;

	//	4.3.2	set_vertical_flip
	virtual __declspec(deprecated("Deprecated. Do not use. Use card property VIDEO_IMAGE_ORIENTATION"))
	BErr	set_vertical_flip(int& On) = 0;

	//	4.3.3	set_output_key
	virtual __declspec(deprecated("Deprecated. Do not use. See AN006_DualLinkSupport.pdf"))
	BErr	set_output_key(int& On, int& v4444, int& Invert, int& White) = 0;

	//	4.3.4	set_output_key_on
	virtual __declspec(deprecated("Deprecated. Do not use. See AN006_DualLinkSupport.pdf"))
	BErr	set_output_key_on(int& On) = 0;

	//	4.3.5	set_output_key_v4444
	virtual __declspec(deprecated("Deprecated. Do not use. See AN006_DualLinkSupport.pdf"))
	BErr	set_output_key_v4444(int& v4444) = 0;

	//	4.3.6	set_output_key_invert
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	set_output_key_invert(int& Invert) = 0;

	//	4.3.7	set_output_key_white
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	set_output_key_white(int& White) = 0;

	//	4.3.8	set_letterbox
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	set_letterbox(unsigned int& Lines, int& Black) = 0;

	//	4.3.9	set_letterbox_lines
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	set_letterbox_lines(unsigned int& Lines) = 0;

	//	4.3.10	set_letterbox_black
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	set_letterbox_black(int& Black) = 0;

	//	4.3.11	set_safearea
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	set_safearea(int& Title, int& Picture) = 0;

	//	4.3.12	set_safearea_title
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	set_safearea_title(int& Title) = 0;

	//	4.3.13	set_safearea_picture
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	set_safearea_picture(int& Picture) = 0;

	//	4.3.14	set_output_video
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	set_output_video(int& Enable) = 0;

	//	4.3.15	set_audio_rate
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	set_audio_rate(unsigned long& Rate) = 0;

	//	4.3.16	set_audio_playthrough
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	set_audio_playthrough(int& Playthru) = 0;

	//	4.3.17	wait_output_video_synch
	virtual BErr wait_output_video_synch(unsigned long UpdFmt, unsigned long& FieldCount) = 0;

	//	4.3.18	get_output_video_synch_count
	virtual BErr get_output_video_synch_count(unsigned long& FieldCount) = 0;

	//	4.3.19	set_scaled_rgb
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	set_scaled_rgb(unsigned long& On) = 0;

	//	4.3.20	wait_pci_interrupt
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	wait_pci_interrupt(unsigned long Wait) = 0;

	//	4.3.21	get_audio_rate
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	get_audio_rate(unsigned long& Rate) = 0;

	//	4.3.22	wait_input_video_synch
	virtual BErr wait_input_video_synch(unsigned long UpdFmt,unsigned long& FieldCount) = 0;

	//	4.3.23	get_input_video_synch_count
	virtual BErr get_input_video_synch_count(unsigned long& FieldCount) = 0;
	...
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	get_video_framestore_style(unsigned long& VidFmt, unsigned long& MemFmt, unsigned long& UpdFmt, unsigned long& ResFmt) = 0;

	//	4.4.12	set_video_framestore_style
	//			Changes the video mode, memory format and update synchronisation styles. 
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	set_video_framestore_style(unsigned long& VidFmt, unsigned long& MemFmt,unsigned long& UpdFmt, unsigned long& ResFmt) = 0;

	//	4.4.13	get_video_engine
	//				Instruct the device driver to change the operational mode of the
	//				video engine. 
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	get_video_engine(unsigned long& Mode) = 0;

	//	4.4.14	set_video_engine
	//				Instruct the device driver to change the operational mode of the
	//				video engine. 
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	set_video_engine(unsigned long& Mode) = 0;
	...
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	system_buffer_map(void** ppAddress, int BufferId) = 0;

	//	4.5.2	system_buffer_unmap
	//			Unmaps the virtual address of one of the driver managed system buffers
	//			from the process address space. 
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	system_buffer_unmap(void* pAddress) = 0;

	//	4.5.3	system_buffer_assign
	//			Assign an arbitrary usermode buffer to a particular DMA function. 
	virtual __declspec(deprecated("Deprecated. Do not use."))
	BErr	system_buffer_assign(void* pAddress, unsigned long Id, unsigned long Length, unsigned long Target) = 0;

	//	4.5.4	system_buffer_write
	//			Instructs the DMA engine to begin a DMA write operation to the
	//			active blue card host buffer. 
	virtual __declspec(deprecated("Deprecated. Use system_buffer_write_async() instead."))
	int		system_buffer_write(unsigned char* pPixels, unsigned long Size, unsigned long Offset = 0) = 0;

	//	4.5.5	system_buffer_read
	//			Instructs the DMA engine to begin a DMA read operation from the
	//			active blue card host buffer. 
	virtual __declspec(deprecated("Deprecated. Use system_buffer_read_async() instead."))
	int		system_buffer_read(unsigned char* pPixels, unsigned long Size, unsigned long Offset = 0) = 0;

	//	4.5.6	system_buffer_write_async
	virtual int system_buffer_write_async(unsigned char* pPixels, unsigned long Size, OVERLAPPED* pAsync, unsigned long BufferID, unsigned long Offset = 0) = 0;

	//	4.5.7	system_buffer_read_async
	virtual int system_buffer_read_async(unsigned char* pPixels, unsigned long Size, OVERLAPPED* pAsync, unsigned long BufferID, unsigned long Offset = 0) = 0;
