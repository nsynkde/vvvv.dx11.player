...
namespace VVVV.Nodes.Bluefish.Nodes
{
	#region PluginInfo
    [PluginInfo(Name = "EnumerateModes", Category = "Bluefish", Version = "Output", Help = "Enumerate available output modes for attached Bluefish devices.", Tags = "", Author = "elliotwoods", AutoEvaluate = true)]
		...
		public void Evaluate(int SpreadMax)
		{
			if (FInRefresh[0] || FInFlags.IsChanged || firstRun)
			{
				...
				try
				{
					...
					EnumManager.UpdateEnum("BluefishkOutputMode", firstKey, ModeRegister.Singleton.EnumStrings);
					FOutStatus[0] = "OK";
				}
				catch(Exception e)
				{
